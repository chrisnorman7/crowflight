...
class AddSavedPlaceWidgetState extends State<AddSavedPlaceWidget> {
  final GlobalKey<FormState> _formKey =
      GlobalKey<FormState>(debugLabel: 'Add saved place form');
  final TextEditingController _titleController = TextEditingController();
  final TextEditingController _latitudeController = TextEditingController(
      text:
          coordinates.latitude == null ? '' : coordinates.latitude.toString());
  final TextEditingController _longitudeController = TextEditingController(
      text: coordinates.longitude == null
          ? ''
  ...
  Widget build(BuildContext context) {
    const TextInputType coordinatesKeyboardType =
    ...
    return Scaffold(
        ...
        body: Form(
            ...
            child: Column(children: <Widget>[
              ...
              TextFormField(
                  decoration: const InputDecoration(
                      labelText: 'Latitude', hintText: 'Latitude coordinate'),
                  keyboardType: coordinatesKeyboardType,
                  controller: _latitudeController,
                  validator: coordinateValidator),
              TextFormField(
                  decoration: const InputDecoration(
                      labelText: 'Longitude', hintText: 'Longitude coordinate'),
                  keyboardType: coordinatesKeyboardType,
