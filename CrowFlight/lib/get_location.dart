...
class CheckLocationPermissionsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Center center =
        Center(child: Text('Checking we have location access...'));
    return MaterialApp(
        title: appName,
        home: Scaffold(appBar: AppBar(title: title), body: center));
  }
}
...
class NoLocationPermissionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Center center = Center(
        child: Text(
            'You have not allowed permissions access, s the app cannot proceed.'));
    final Scaffold scaffold = Scaffold(appBar: appBar, body: center);
    return scaffold;
  }
}
