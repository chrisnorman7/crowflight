...
class SettingsTabState extends State<SettingsTab> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> rows = <Widget>[
      CheckboxListTile(
          ...
          onChanged: (bool value) {
            setState(() {
              ...
              savePreferenceBool(
                  vibrationEnabledPreferenceName, vibrationEnabled);
            });
          }),
      ListTile(
          ...
          trailing: DropdownButton<CompassStyle>(
              ...
              value: compassStyle,
              items: compassStyles.entries
                  .map((MapEntry<CompassStyle, String> entry) {
              ...
              onChanged: (CompassStyle value) {
                setState(() {
                  compassStyle = value;
                  savePreferenceInt(
                      compassStylePreferenceName, compassStyle.index);
                });
              })),
      ListTile(
          ...
          trailing: DropdownButton<LocationAccuracy>(
              ...
              value: gpsAccuracy,
              items: gpsAccuracies.entries
                  .map((MapEntry<LocationAccuracy, String> entry) {
      ...
      ListTile(
          title: const Text(
              'Length of vibrations (in milliseconds) felt after arrival'),
                  ...
                  onChanged: (String value) {
                    if (value.isNotEmpty) {
                      ...
                      if (n != null && n >= 10) {
                        ...
                        savePreferenceInt(
                            arrivedVibrationDurationPreferenceName,
      ...
      ListTile(
          title: const Text(
              'Length of vibrations (in milliseconds) felt while approaching destination'),
          subtitle: const Text('No less than 10'),
          trailing: Container(
              width: 100,
              child: TextField(
                  ...
                  onChanged: (String value) {
                    if (value.isNotEmpty) {
                      ...
                      if (n != null && n >= 10) {
                        ...
                        savePreferenceInt(movingVibrationDurationPreferenceName,
      ...
      ListTile(
          title: const Text(
              'Number to multiply the distance by to determine time between vibrations'),
                  ...
                  onChanged: (String value) {
                    if (value.isNotEmpty) {
                      ...
                      if (n != null && n >= 1) {
                        ...
                        savePreferenceInt(distanceMultiplierPreferenceName,
                            distanceMultiplier);
                      }
                    }
                  }))),
                  ...
                  onChanged: (String value) {
                    if (value.isNotEmpty) {
                      ...
                      if (n != null && n >= 100) {
                        vibrateInterval = n;
                        savePreferenceInt(
                            vibrateIntervalPreferenceName, vibrateInterval);
                      }
                    }
                  }))),
    ];
...
final CrowFlightTab settings =
    CrowFlightTab('Settings', Icons.settings, SettingsTab());
